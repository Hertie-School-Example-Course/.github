...
**Example Course (prototype)** - managed by the Hertie Data Science Lab.
...
| --- | --- | --- |
| [assignment-1-f2025](https://github.com/Hertie-School-Example-Course/assignment-1-f2025) | private | Assignment 1 - Fall 2025 |
| [content-f2025](https://github.com/Hertie-School-Example-Course/content-f2025) | public | Course materials - Fall 2025 |
| [hertie-school-example-course.github.io](https://github.com/Hertie-School-Example-Course/hertie-school-example-course.github.io) | public | Course website - Example Course |
| [preview-1-red](https://github.com/Hertie-School-Example-Course/preview-1-red) | public | Course website - Theme preview (Hertie red) |
| [preview-2-dark](https://github.com/Hertie-School-Example-Course/preview-2-dark) | public | DSL-themed course template preview (wholesale fork) |

## Available actions for faculty & admin

All actions live in the [`.github` repo's Actions tab](https://github.com/Hertie-School-Example-Course/.github/actions)
...
- [**Bootstrap cohort**](https://github.com/Hertie-School-Example-Course/.github/actions/workflows/bootstrap-cohort.yml) - configure a freshly-created cohort org (sets up scaffold repos), register it with the course org, refresh dropdowns.
- [**Enroll student**](https://github.com/Hertie-School-Example-Course/.github/actions/workflows/enroll-student.yml) - grant a student access to the cohort org; provision them with student-level permissions.
- [**New materials repo**](https://github.com/Hertie-School-Example-Course/.github/actions/workflows/new-materials.yml) - scaffold a correctly-structured `course-materials-<year>` repo (week folders + the Release buttons).
- [**New assignment**](https://github.com/Hertie-School-Example-Course/.github/actions/workflows/new-assignment.yml) - scaffold an `assignment-N-<year>` template repo (starter + autograder on `main`, an empty `solution` branch).
- [**Refresh actions**](https://github.com/Hertie-School-Example-Course/.github/actions/workflows/refresh-actions.yml) - repopulate the cohort/week/assignment dropdowns, re-equip content repos, and rebuild this index.

### Weekly cadence actions:
- [**Release materials**](https://github.com/Hertie-School-Example-Course/.github/actions/workflows/release-materials.yml) - publish a given week's `lectures/`+`readings/` into a cohort repo.
- [**Release assignment**](https://github.com/Hertie-School-Example-Course/.github/actions/workflows/release-assignment.yml) - generate one private repo per student from a chosen `assignment-*` template repo.
...
- _[**Sync site**](https://github.com/Hertie-School-Example-Course/.github/actions/workflows/sync-site.yml) - regenerate a cohort's website from the org structure (releases do this automatically; standard workflow has no need for manual sync)._
...
```
Hertie-School-Example-Course/                            <- this COURSE org (persistent)
